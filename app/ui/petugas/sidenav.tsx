...
export default function SideNav() {
  ...
  return (
    <>
      ...
      <div className={`hidden md:flex h-full w-[260px] flex-col bg-black px-6 py-4 text-white`}>
        {/* Logo */}
      ...
      <div className="fixed bottom-0 left-0 w-full bg-white shadow-md md:hidden">
        <div className="flex justify-around py-3">
          ...
          <Link href="/dashboard/history" className="flex flex-col items-center text-gray-700">
            <RiHistoryFill className="text-2xl" />
          </Link>
          <button onClick={() => setIsOpen(!isOpen)} className="flex flex-col items-center text-gray-700">
