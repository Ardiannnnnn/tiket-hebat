...
export default function OrderTable() {
  const [orders, setOrders] = useState([
    { id: "C01", name: "Ardian", address: "Air Dingin", age: 18, gender: "Pria", idType: "KTP", idNumber: "112345678912345678", class: "Bisnis" },
    { id: "C02", name: "Budi", address: "Jakarta", age: 22, gender: "Pria", idType: "KTP", idNumber: "112345678912345679", class: "Ekonomi" },
    { id: "C03", name: "Citra", address: "Bandung", age: 25, gender: "Wanita", idType: "SIM", idNumber: "112345678912345680", class: "VIP" },
  ]);
  ...
  const handleAddOrder = () => {
    ...
    setNewOrder({ id: "", name: "", address: "", age: "", gender: "", idType: "", idNumber: "", class: "" });
  };
          ...
          <Dialog open={isAddModalOpen} onOpenChange={setIsAddModalOpen}>
            ...
            <DialogContent>
              ...
              <div className="flex flex-col gap-2">
                ...
                <Input placeholder="Alamat" value={newOrder.address} onChange={(e) => setNewOrder({ ...newOrder, address: e.target.value })} />
                <Input placeholder="Umur" type="number" value={newOrder.age} onChange={(e) => setNewOrder({ ...newOrder, age: e.target.value })} />
                <Input placeholder="Jenis Kelamin" value={newOrder.gender} onChange={(e) => setNewOrder({ ...newOrder, gender: e.target.value })} />
                <Input placeholder="Jenis ID" value={newOrder.idType} onChange={(e) => setNewOrder({ ...newOrder, idType: e.target.value })} />
                <Input placeholder="No ID" value={newOrder.idNumber} onChange={(e) => setNewOrder({ ...newOrder, idNumber: e.target.value })} />
                <Input placeholder="Kelas" value={newOrder.class} onChange={(e) => setNewOrder({ ...newOrder, class: e.target.value })} />
                ...
                <td className="border border-gray-200 px-4 py-2">
                  <AlertDialog>
                    <AlertDialogTrigger asChild>
                      <Button className="bg-yellow-300 text-black hover:text-white" onClick={() => setSelectedOrder(order)}>
                        Verifikasi
                      </Button>
                    </AlertDialogTrigger>
                    <AlertDialogContent>
